export default function Footer(){
    return (
        <footer className="shadow-inner shadow-slate-950 bg-slate-800 py-4 px-8 text-justify rounded-t-lg -mt-1 grid grid-cols-3">
                ...
                <section className=" col-span-2 my-2 grid min-[640px]:grid-cols-2">
                    ...
                    <p className="text-md font-bold text-slate-200 lg:text-xl min-[640px]:col-start-2 min-[640px]:row-start-1">Social Media:</p>
